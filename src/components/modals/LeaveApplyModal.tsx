      ...
      >
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            <Form.Item
              name="start_date"
              label={<span className="text-xs font-bold text-[#111111]">Start Date <span className="text-[#ff3b3b]">*</span></span>}
          ...
          <Form.Item
            name="day_type"
            label={<span className="text-xs font-bold text-[#111111]">Day Type <span className="text-[#ff3b3b]">*</span></span>}
          ...
          <Form.Item
            name="leave_type"
            label={<span className="text-xs font-bold text-[#111111]">Leave Type <span className="text-[#ff3b3b]">*</span></span>}
          ...
          <Form.Item
            name="reason"
            label={<span className="text-xs font-bold text-[#111111]">Reason <span className="text-[#ff3b3b]">*</span></span>}
