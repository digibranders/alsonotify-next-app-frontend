  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 gap-x-4 gap-y-4">
        ...
        <div className="col-span-6 space-y-1">
          <span className="text-xs font-bold text-[#111111]">Salary (CTC) <span className="text-[#666666] font-normal text-2xs ml-1">(Annual)</span></span>
        ...
        <div className="col-span-6 space-y-1">
          <span className="text-xs font-bold text-[#111111]">Hourly Cost <span className="text-[#666666] font-normal text-2xs ml-1">(Calculated)</span></span>
          <Input
