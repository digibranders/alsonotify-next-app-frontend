            ...
            {isOpen && (
                <div className="absolute z-50 w-full mt-2 bg-white border border-[#EEEEEE] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] max-h-80 flex flex-col overflow-hidden">
                    <div className="p-3 border-b border-[#EEEEEE] shrink-0">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-9 pr-3 py-2 text-[13px] border border-[#EEEEEE] rounded-lg focus:outline-none focus:border-[#111111] focus:ring-1 focus:ring-[#111111] transition-colors"
                                value={search}
                    ...
                    <div className="overflow-y-auto flex-1 p-2">
                        {isLoading ? (
                            <div className="px-4 py-8 text-center text-[13px] text-[#697386]">Loading requirements...</div>
                        ) : filteredRequirements.length === 0 ? (
                            <div className="px-4 py-8 text-center text-[13px] text-[#697386]">No matching requirements found.</div>
                        ) : (
