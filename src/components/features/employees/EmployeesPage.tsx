      ...
      <div className="flex flex-col h-full relative">
        ...
        <div className="flex-1 overflow-y-auto pb-24">
          ...
          <div className="sticky top-0 z-20 bg-white grid grid-cols-[40px_2fr_1.8fr_1.2fr_1fr_1fr_1.2fr_40px] gap-4 px-4 py-3 mb-2 items-center">
            ...
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Name</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Email Address</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Access Level</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Type</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Hourly Rate</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider">Date of Joining</p>
            <p className="text-2xs font-bold text-[#6B7280] uppercase tracking-wider"></p>
          </div>
