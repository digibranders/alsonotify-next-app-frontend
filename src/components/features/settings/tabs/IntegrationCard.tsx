            ...
            <div className="p-6">
                <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="flex flex-col items-end gap-2">
                        {connected ? (
                            <Tag color={isExpired ? "error" : "success"} className="rounded-full px-3 border-none flex items-center gap-1 font-semibold text-xs uppercase tracking-wider py-0.5">
                                {isExpired ? <AlertCircle className="w-3 h-3" /> : <Check className="w-3 h-3" />}
                                {isExpired ? "Action Required" : "Connected"}
                            </Tag>
                        ) : (
                            <Tag className="rounded-full px-3 bg-[#F0F0F0] text-[#999999] border-none font-semibold text-xs uppercase tracking-wider py-0.5">
                                Available
                            </Tag>
                        )}
                    </div>
            ...
            {connected && metadata && (
                <div className="px-6 py-4 bg-[#FAFAFA] border-t border-[#F0F0F0] flex items-center justify-between">
                    <div className="flex flex-col">
                        <span className="text-xs text-[#999999] uppercase tracking-tighter font-semibold">Updated</span>
                    ...
                    <div className="flex flex-col items-end">
                        <span className="text-xs text-[#999999] uppercase tracking-tighter font-semibold">Admin</span>
