    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-[16px] p-8 border border-[#EEEEEE] shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {/* Type */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Type</p>
          ...
          {/* Partner / Company */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Partner / Company</p>
          ...
          {/* Start Date */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Start Date</p>
            <p className="text-sm font-medium text-[#111111]">
          ...
          {/* End Date */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Due Date</p>
            <p className="text-sm font-medium text-[#111111]">
          ...
          {/* Contact Person */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Contact Person</p>
            <p className="text-sm font-medium text-[#111111]">
          ...
          {requirement.type !== 'inhouse' && !['inhouse', 'Inhouse'].includes(requirement.type || '') && (
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Quoted Price</p>
              <p className="text-sm font-medium text-[#111111]">
          ...
          {/* Total Tasks */}
          <div>
            <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Total Tasks</p>
            <p className="text-sm font-medium text-[#111111]">
          ...
          {requirement.leader_user && (
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Leader</p>
              <p className="text-sm font-medium text-[#111111]">
          ...
          {requirement.manager_user && (
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Manager</p>
              <p className="text-sm font-medium text-[#111111]">
          ...
          {sanitizeUrl(requirement.document_link) && (
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Document</p>
              <a
          ...
          {requirement.is_high_priority && (
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wider mb-2">Priority</p>
