    ...
    if (visibleTasks.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-3 bg-[#FAFAFA]">
                ...
                <p className="text-xs-tight font-normal text-[#BBBBBB]">Add start and end dates to tasks to see them here</p>
            </div>
        );
    }
            ...
            {(task.start_date || task.end_date) && (
                ...
                >
                    ...
                    <div className="relative z-10 flex items-center w-full px-2 overflow-hidden">
                        <span className="text-xxs font-bold truncate uppercase tracking-tight"
            ...
            {tooltip && (
                ...
                >
                    <div className="bg-[#111111] text-white rounded-[8px] px-3 py-2 shadow-lg min-w-[160px]">
                        <p className="text-xs-tight font-bold mb-1.5 text-white truncate max-w-[220px]">{task.name}</p>
                        {task.start_date && (
                            <p className="text-xxs font-normal text-[#AAAAAA]">
                        ...
                        {task.progress != null && (
                            <div className="mt-1.5">
                                <div className="flex items-center justify-between mb-0.5">
                                    <span className="text-3xs font-bold text-[#AAAAAA] uppercase tracking-wide">Progress</span>
                                    <span className="text-3xs font-bold text-white">{task.progress}%</span>
                                </div>
