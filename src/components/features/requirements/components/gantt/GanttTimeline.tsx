    ...
    if (visibleTasks.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-3 bg-[#FAFAFA]">
                ...
                <p className="text-[13px] font-['Manrope:SemiBold',sans-serif] text-[#999999]">No tasks with dates to display</p>
                <p className="text-[11px] font-['Manrope:Regular',sans-serif] text-[#BBBBBB]">Add start and end dates to tasks to see them here</p>
            </div>
        );
    }
            ...
            {(task.start_date || task.end_date) && (
                ...
                >
                    ...
                    <div className="relative z-10 flex items-center w-full px-2 overflow-hidden">
                        <span className="text-[10px] font-['Manrope:Bold',sans-serif] truncate uppercase tracking-tight"
            ...
            {tooltip && (
                ...
                >
                    <div className="bg-[#111111] text-white rounded-[8px] px-3 py-2 shadow-lg min-w-[160px]">
                        <p className="text-[11px] font-['Manrope:Bold',sans-serif] mb-1.5 text-white truncate max-w-[220px]">{task.name}</p>
                        {task.start_date && (
                            <p className="text-[10px] font-['Manrope:Regular',sans-serif] text-[#AAAAAA]">
                        ...
                        {task.progress != null && (
                            <div className="mt-1.5">
                                <div className="flex items-center justify-between mb-0.5">
                                    <span className="text-[9px] font-['Manrope:Bold',sans-serif] text-[#AAAAAA] uppercase tracking-wide">Progress</span>
                                    <span className="text-[9px] font-['Manrope:Bold',sans-serif] text-white">{task.progress}%</span>
                                </div>
