                                ...
                                <tbody>
                                    {invoices.map((inv, idx) => (
                                        <tr key={inv.id} className={idx !== invoices.length - 1 ? 'border-b border-[#EEEEEE]' : ''}>
                                            ...
                                            <td className="px-4 py-3">
                                                <p className="text-[13px] text-[#697386]">{inv.date ? dayjs(inv.date).format('MMM D, YYYY') : '--'}</p>
                                            </td>
                                            <td className="px-4 py-3">
                                                <p className="text-[13px] font-medium text-[#111111]">₹{inv.amount.toLocaleString()}</p>
                                            </td>
                                            <td className="px-4 py-3">
