      ...
      <div className="bg-white rounded-[16px] p-6 border border-[#EEEEEE] shadow-sm overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-[14px] px-5 py-4 border border-[#EEEEEE] shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide mb-0.5">Quoted Price</p>
          ...
          <div className="bg-white rounded-[14px] px-5 py-4 border border-[#EEEEEE] shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide mb-0.5">Resource Cost</p>
          ...
          <div className={`bg-white rounded-[14px] px-5 py-4 border shadow-sm flex items-center gap-4 ${summary.netProfit >= 0 ? 'border-[#0F9D58]' : 'border-[#DC2626]'}`}>
            ...
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide mb-0.5">
          ...
          <div className="bg-white rounded-[14px] px-5 py-4 border border-[#EEEEEE] shadow-sm flex items-center gap-4">
            ...
            <div>
              <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide mb-0.5">Hours</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#F7F7F7] border-b border-[#EEEEEE]">
              <tr>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider">Task</th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider">Assignee</th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider text-right">Est. Hours</th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider text-right">Actual</th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider text-right">Over/Under</th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider text-right">
                  <Tooltip title="Actual hours × hourly rate">
                    <span className="cursor-help">Cost</span>
                  </Tooltip>
                </th>
                <th className="px-5 py-4 text-2xs font-bold text-[#666666] uppercase tracking-wider text-right">P/L</th>
              </tr>
            </thead>
