                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <span className={`text-2xs px-1.5 py-0.5 rounded font-mono ${isRevision ? 'bg-[#FFF5F5] text-[#ff3b3b]' : 'bg-[#F7F7F7] text-[#999999]'
                            }`}>
                            #{task.id}
                          </span>
                        ...
                        {/* Due Date */}
                        {task.end_date && (
                          <div className="flex items-center gap-1.5 mb-3 text-xs text-[#666666]">
                        ...
                        <div className="flex items-center gap-2 pt-2 border-t border-[#EEEEEE]">
                          ...
                          <span className="text-xs text-[#666666] font-medium truncate">
                            {assignee.name}
                          </span>
                        </div>
                      </div>
