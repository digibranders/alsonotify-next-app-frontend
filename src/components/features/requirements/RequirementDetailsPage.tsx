              ...
              <div className="bg-white rounded-[16px] p-8 border border-[#EEEEEE] shadow-sm">
                ...
                <div className="px-4 pb-3 mb-2">
                  <div className="grid grid-cols-[40px_3.6fr_0.9fr_0.7fr_1.5fr_0.5fr_40px] gap-4 items-center">
                    ...
                    <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Task</p>
                    <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Timeline</p>
                    <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Assigned</p>
                    <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Progress</p>
              ...
              {revisions.length > 0 && (
                <div className="bg-white rounded-[16px] p-8 border border-[#EEEEEE] shadow-sm">
                  ...
                  <div className="grid grid-cols-[40px_1fr_200px_150px_120px_40px] gap-4 px-4 pb-3 mb-2 border-b border-[#EEEEEE] items-center">
                    ...
                    <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Revision</p>
                    <div className="flex justify-center">
                      <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Assigned</p>
                    </div>
                    <div className="flex justify-center">
                      <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Due Date</p>
                    </div>
                    <div className="flex justify-center">
                      <p className="text-2xs font-bold text-[#999999] uppercase tracking-wide">Status</p>
                    </div>
