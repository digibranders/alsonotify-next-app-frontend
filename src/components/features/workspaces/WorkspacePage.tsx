          ...
          viewMode === 'grid' ? (
            ...
            <div className="flex flex-col gap-3">
              <div className="grid grid-cols-[40px_1.5fr_1.8fr_0.8fr_0.5fr_40px] gap-4 px-4 py-3 items-center bg-white">
                ...
                <p className="text-xs font-semibold text-[#999999] uppercase tracking-wider">Workspace Name</p>
                <p className="text-xs font-semibold text-[#999999] uppercase tracking-wider">Requirements</p>
                <p className="text-xs font-semibold text-[#999999] uppercase tracking-wider">Organization</p>
...
function WorkspaceRequirementsSummary({
  ...
  return (
    <div>
      <p className="text-xs text-[#999999] font-semibold uppercase tracking-wider text-center mb-3">Requirements</p>
      <div className="grid grid-cols-3 divide-x divide-[#EEEEEE]">
        <div className="flex flex-col items-center px-1">
          <span className="text-xs text-[#999999] font-medium uppercase tracking-wider mb-0.5">Total</span>
          <span className="text-xs text-[#111111] font-bold">{total}</span>
        </div>
        <div className="flex flex-col items-center px-1">
          <span className="text-xs text-[#999999] font-medium uppercase tracking-wider mb-0.5">Progress</span>
          <span className="text-xs text-[#0284C7] font-bold">{inProgress}</span>
        </div>
        <div className="flex flex-col items-center px-1">
          <span className="text-xs text-[#999999] font-medium uppercase tracking-wider mb-0.5">Delayed</span>
    ...
    <>
      ...
      >
        <div className="grid grid-cols-[40px_1.5fr_1.8fr_0.8fr_0.5fr_40px] items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <div className="flex flex-col">
              <span className="text-xs text-[#999999] font-medium mb-0.5">
                Total
              </span>
