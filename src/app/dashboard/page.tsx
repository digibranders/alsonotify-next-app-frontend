...
export default function DashboardPage() {
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col gap-3 overflow-y-auto xl:overflow-hidden min-h-0 pr-1 xl:pr-0">
        {/* Desktop Layout (>1280px) - Two-column flex with relative vertical scaling */}
        <div className="hidden xl:flex gap-3 flex-1 h-full min-h-[500px] overflow-y-auto overflow-x-hidden">
          {/* Main Column (2/3) */}
          <div className="flex-[2] flex flex-col gap-3 h-full min-w-0">
        ...
        <div className="xl:hidden grid grid-cols-1 md:grid-cols-2 gap-3 flex-1 overflow-y-auto pr-1">
