...
const UserAvatar = ({ name }: { name?: string | null }) => {
  ...
  return (
    <div
      className="w-6 h-6 rounded-full flex items-center justify-center text-xxs font-bold text-white shrink-0"
                  ...
                  >
                    ...
                    <div className="min-w-0 pr-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs-tight text-[#999999] font-medium truncate">
                           {item.description}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                      <div
                        className="px-2 py-0.5 rounded-lg text-xs-tight font-bold flex items-center gap-1.5 whitespace-nowrap"
                    ...
                    {/* Date */}
                    <div className="text-center text-xxs font-medium text-[#999999] whitespace-nowrap">
            ...
            <div className="pt-2">
              <div className="grid grid-cols-3 gap-8">
                <div className="col-span-2">
                  ...
                  <p className="text-sm-plus text-[#666666] font-normal whitespace-pre-wrap mb-6 leading-relaxed">
